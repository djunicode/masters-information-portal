      ...
      <List>
        ...
        {!props.loggedIn ? (
          ...
          <React.Fragment>
            ...
            <Divider />
            <NavLink className={classes.link} to="/edit">
              <ListItem button>
                <ListItemIcon>
                  <EditIcon />
                </ListItemIcon>
            ...
            <Divider />
            <NavLink className={classes.link} to="/question-reply">
              <ListItem button>
                <ListItemIcon>
                  <ForumIcon />
                </ListItemIcon>
        ...
        <NavLink className={classes.link} to="/resources">
          <ListItem button>
            <ListItemIcon>
              <DescriptionIcon />
            </ListItemIcon>
        ...
        {props.loggedIn ? (
          <React.Fragment>
            <Divider />
            <NavLink className={classes.link} to="/add-resource">
              <ListItem button>
                <ListItemIcon>
                  <PostAddIcon />
                </ListItemIcon>
