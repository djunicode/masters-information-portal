...
export default function AddForum(props) {
  ...
  setDetails();
    fetch('/api/tags').then(data => data.json())
        ...
        <Paper elevation={3} className={classes.paper}>
          ...
          <br /> 
            ...
            {/* <Autocomplete
                    ...
                    id="tags-filled"
                    onChange={handleTags}
                    options={tags.map((option) => option.slug)}
                    ...
                    renderInput={(params) => (
                      <TextField {...params} variant="filled" className={classes.textField} label="Tags" placeholder="" multiline rows={2}/>
                    )}
                  /> */}
                     <Autocomplete
                        multiple
